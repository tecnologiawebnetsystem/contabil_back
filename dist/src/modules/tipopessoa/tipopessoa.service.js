...
exports.TipopessoaService = void 0;
...
let TipopessoaService = class TipopessoaService {
    ...
    async create(createTipopessoaDto) {
    ...
    async findOne(id) {
        ...
        if (!found) {
            throw new common_1.NotFoundException(`Tipopessoa with id "${id}" not found`);
        }
        return found;
    }
    async update(id, updateTipopessoaDto) {
...
exports.TipopessoaService = TipopessoaService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(tipopessoa_entity_1.Tipopessoa)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], TipopessoaService);
//# sourceMappingURL=tipopessoa.service.js.map