...
let Tipocontrato = class Tipocontrato extends base_entity_1.BaseEntity {
};
exports.Tipocontrato = Tipocontrato;
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)(),
    __metadata("design:type", Number)
], Tipocontrato.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, typeorm_1.Column)({ name: 'created_at', nullable: true }),
    __metadata("design:type", Date)
], Tipocontrato.prototype, "created_at", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, typeorm_1.Column)({ name: 'seguradora_id', nullable: true }),
    __metadata("design:type", Number)
], Tipocontrato.prototype, "seguradora_id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
...
exports.Tipocontrato = Tipocontrato = __decorate([
    (0, typeorm_1.Entity)('TipoContrato')
], Tipocontrato);
//# sourceMappingURL=tipocontrato.entity.js.map